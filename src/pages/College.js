...
const College = () => {
  ...
  const SUBJECT_ICONS = {
    mathématiques: <FaCalculator className="subject-icon" />,
    physique: <FaFlask className="subject-icon" />,
    chimie: <FaFlask className="subject-icon" />,
    français: <FaLanguage className="subject-icon" />,
    histoire: <FaHistory className="subject-icon" />,
    géographie: <FaGlobeAmericas className="subject-icon" />,
    anglais: <FaLanguage className="subject-icon" />,
    svt: <FaFlask className="subject-icon" />,
    technologie: <FaChalkboardTeacher className="subject-icon" />
  };
...
const filteredFiles = useMemo(() => {
  ...
  const LessonSection = React.memo(({ lessonKey, lessonData }) => {
    const subjectIcon = SUBJECT_ICONS[selections.subject.toLowerCase()] || <FaBook className="subject-icon" />;
        ...
        >
          <div className="main-container">
            ...
            <p className="page-subtitle text-center">
              Découvrez toutes les ressources pédagogiques pour le collège
            </p>
          </div>
        </motion.div>
