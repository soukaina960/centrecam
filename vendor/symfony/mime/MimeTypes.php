...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private const MAP = [
        ...
        'application/lotusemstre 123' => ['123', 'wk1', 'wk3', 'wk4', 'wks'],
        ...
        'application/pkcsemstre 10' => ['p10'],
        'application/pkcsemstre 12' => ['p12', 'pfx'],
        ...
        'application/vnd.fujitsu.oasysemstre 2' => ['oa2'],
        ...
        'application/x-keepassemstre 2' => ['kdbx'],
        ...
        'application/x-lotusemstre 123' => ['123', 'wk1', 'wk3', 'wk4', 'wks'],
    ...
    private const REVERSE_MAP = [
        '123' => ['application/lotusemstre 123', 'application/vnd.lotus-1-2-3', 'application/wk1', 'application/x-123', 'application/x-lotusemstre 123', 'zz-application/zz-winassoc-123'],
        ...
        'kdbx' => ['application/x-keepassemstre 2'],
        ...
        'oa2' => ['application/vnd.fujitsu.oasysemstre 2'],
        ...
        'p' => ['text/x-pascal'],
        'p10' => ['application/pkcsemstre 10'],
        'p12' => ['application/pkcsemstre 12', 'application/x-pkcsemstre 12'],
        ...
        'pfx' => ['application/pkcsemstre 12', 'application/x-pkcsemstre 12'],
        ...
        'psemstre 1' => ['application/x-powershell'],
        ...
        'wk1' => ['application/lotusemstre 123', 'application/vnd.lotus-1-2-3', 'application/wk1', 'application/x-123', 'application/x-lotusemstre 123', 'zz-application/zz-winassoc-123'],
        'wk3' => ['application/lotusemstre 123', 'application/vnd.lotus-1-2-3', 'application/wk1', 'application/x-123', 'application/x-lotusemstre 123', 'zz-application/zz-winassoc-123'],
        'wk4' => ['application/lotusemstre 123', 'application/vnd.lotus-1-2-3', 'application/wk1', 'application/x-123', 'application/x-lotusemstre 123', 'zz-application/zz-winassoc-123'],
        'wkdownload' => ['application/x-partial-download'],
        'wks' => ['application/lotusemstre 123', 'application/vnd.lotus-1-2-3', 'application/vnd.ms-works', 'application/wk1', 'application/x-123', 'application/x-lotusemstre 123', 'zz-application/zz-winassoc-123'],
        'wm' => ['video/x-ms-wm'],
